...
# 210 "./mcc_generated_files/eusart1.h"
_Bool EUSART1_is_rx_ready(void);
# 257 "./mcc_generated_files/eusart1.h"
_Bool EUSART1_is_tx_done(void);
# 305 "./mcc_generated_files/eusart1.h"
eusart1_status_t EUSART1_get_last_status(void);
# 325 "./mcc_generated_files/eusart1.h"
uint8_t EUSART1_Read(void);
# 345 "./mcc_generated_files/eusart1.h"
void EUSART1_Write(uint8_t txData);
# 365 "./mcc_generated_files/eusart1.h"
void EUSART1_SetFramingErrorHandler(void (* interruptHandler)(void));
# 383 "./mcc_generated_files/eusart1.h"
...
# 46 "main.c" 2
# 61 "main.c"
uint8_t adc_software_reset[2] = {0x14,0x80};
uint8_t channel_config[2] = {0x19,0x0F};
uint8_t lock_adc_registers[2] = {0x14,0x02};
uint8_t continous_conversion[2] = {0x14,0x01};
uint8_t trigger_conversion[2] = {0x1C,0x00};
...
void main(void)
{
    ...
    send_string("FIRST Digital data: "); send_string(DigitalBuffer); send_string("\n");
    while (1)
    {
        send_string("HELLO!\n");
        ADC_read();
        ...
        send_string("////////////       CHANNEL1");send_string("       ////////////\n");
            ...
            SC_voltage = (double)(ADC_result[channel]*5)/4096;
...
void ADC_init(void){
    i2c_driver_write_byte(0x40, 0x19, 0x0F);
    i2c_driver_write_byte(0x40, 0x14, 0x02);
}


void ADC_reset(void){
    send_string("Start of reset \n");
    i2c_driver_write_byte(0x40,0x14,0x80);

    send_string("End of reset \n");
}

void ADC_read(void){
    send_string("before trigger\n");
    i2c_driver_write_byte(0x40, 0x14, 0x02);
    i2c_driver_write_byte(0x40,0x1C, 0x00);
    uint8_t ADC_data[2];
    send_string("after trigger\n");
    uint8_t busy_status;
    do{
    send_string("before checking busy state\n");
    i2c_driver_read_byte(0x40,0x10,&busy_status);}while(busy_status & (1<<7) !=0);
    send_string("after checking busy state\n");
    i2c_driver_write_byte(0x40, 0x14, 0x00);



    i2c_driver_read_twobytes(0x40, 0x20, &ADC_result0);

    send_string("after reading\n");
# 192 "main.c"
}
